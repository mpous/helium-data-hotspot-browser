...
This is a balena version based on the [balena helium data-only hotspot](https://hub.balena.io/organizations/marc6/apps/helium-data-only) running along with the [browser block](https://github.com/balenablocks/browser) and the [audio block](https://github.com/balenablocks/audio).
...
[![](https://www.balena.io/deploy.png)](https://dashboard.balena-cloud.com/deploy?repoUrl=https://github.com/mpous/helium-data-hotspot-browser)
